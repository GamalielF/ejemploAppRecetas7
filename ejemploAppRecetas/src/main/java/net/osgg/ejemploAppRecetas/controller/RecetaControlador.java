...
import net.osgg.ejemploAppRecetas.repository.RecetaRepo;
import net.osgg.ejemploAppRecetas.service.PictureService;
@Controller
...
public class RecetaControlador {
	...
	@GetMapping("/add_recipe") //revisar
	public String ShowSingnUpFrom(Receta receta) {
		return "add_recipe";
	}
	@GetMapping("/list")
